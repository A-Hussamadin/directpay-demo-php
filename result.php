...
if($_POST['Response_GatewayStatusCode'] == "CAPTURED"){
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                ...
                if($result=="Success"){
                    ...
                    echo '<h2>Your Payment was Successful Your Reference is :<strong>'. $transactionId .'</strong></h2>';
                }else{
                    echo '<h2>Your Payment was Rejected Please try again later</h2>';
                }
                ?>
            </div>
